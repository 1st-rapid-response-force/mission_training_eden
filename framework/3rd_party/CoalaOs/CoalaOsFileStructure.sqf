...
coala_FileSystem = [["C:", 0, 0, [1,2, 17, 18, 19, 20, 21], 1], 
					["Arma", 1, 0, [6,7,10,14,15,16], 1], 
					["Windows", 2, 0, [5,8,9], 1], 
					["image.jpg", 3, 0, [], 0, MISSION_ROOT + "framework\3rd_party\CoalaOS\Images\617x.jpg", "image"], 
					["Image2.Jpeg", 4, 1, [], 0, MISSION_ROOT + "framework\3rd_party\CoalaOS\Images\tank.jpg", "image"], 
					["SuperImportantFile.Jpeg", 5, 2, [], 0, MISSION_ROOT + "framework\3rd_party\CoalaOS\Images\tank.jpg", "image"], 
					["Arma3.exe", 6, 1, [], 0, "", "exe"], 
					["Arma3.Jpeg", 7, 1, [], 0, MISSION_ROOT + "framework\3rd_party\CoalaOS\Images\tank.jpg", "image"], 
