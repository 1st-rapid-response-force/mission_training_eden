...
*/
#define SELF RR_fnc_startCondition
...
{
	if !(missionNamespace getVariable format ["%1_STATES_ARRAY", _rangeID] select _x select 2) exitWith {_bool = false};
