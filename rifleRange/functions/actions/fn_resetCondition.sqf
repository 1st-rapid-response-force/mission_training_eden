...
*/
#define SELF RR_fnc_resetCondition
...
{
	if !(missionNamespace getVariable format ["%1_STATES_ARRAY", _rangeID] select _x select 1) exitWith {_condition = false};
